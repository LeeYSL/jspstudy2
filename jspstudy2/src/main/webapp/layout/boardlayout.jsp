	...
	<nav class="w3-sidebar w3-collapse w3-white w3-animate-left"
		...
		<div class="w3-bar-block">
			<a href="#"
				...
				class="fa fa-users fa-fw"></i>&nbsp; 회원관리
			</a> <a href="${path}/board/list?boardid=1"
				class="w3-bar-item w3-button w3-padding"> <i
				class="fa fa-eye fa-fw"></i>&nbsp; 공지사항
			</a> <a href="${path}/board/list?boardid=2"
				class="w3-bar-item w3-button w3-padding"> <i
				class="fa fa-users fa-fw"></i>&nbsp; 자유게시판
			</a> <a href="${path}/board/list?boardid=3"
				class="w3-bar-item w3-button w3-padding"> <i
				class="fa fa-users fa-fw"></i>&nbsp; QNA
			</a>
		</div>
		...
		function getText(name) { //si : 시도 선택한 경우, gu : 구군을 선택한 경우
			...
			$.ajax({ 
				...
				success : function(data) {
					console.log(data)
					let arr = JSON.parse(data)
					$("select[name=" + disname + "] option").remove() //전에 조회한 내용을 없애기 위해서?
