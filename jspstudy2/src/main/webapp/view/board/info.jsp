...
<%--
     ...
     3.num값의 게시물의 조회 수 증가시키기
       void BoarDao.readcntAdd(num)
     4.조회된 게시물 화면에 출력  --%>
...
<body>
	<div class="w3-center">
		...
		<table class="w3-table-all">
			...
			<tr>
				<th>내용</th>
				<td><table style="width: 100%; height: 250pxl;">
						<tr>
							<td
...
<form action="comment" method="post">
	...
	<div class="w3-row">
		...
		<div class="w3-col s1 w3-center">
			<p>
				<button type="submit" class="w3-btn w3-boarder">댓글등록</button>
			</p>
		</div>
	</div>
</form>
	...
	<table class="w3-table-all">
		<c:forEach var="c" items="${commlist}">
			<tr>
				...
				<td>${c.content}</td>
				<td>${c.regdate}</td>
				<td class="w3-right"><a class="w3-btn w3-boarder w3-blue" 
