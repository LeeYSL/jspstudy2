...
<div class="container">
  ...
  <div class="row">
	  <div class="col-3 bg-light" id="center"> <!-- col: 컬럼 3개가 div로 간다.? -->
  		 <img src="" width="95%" height="200" id="pic">
  ...
  <div class="col-9">
  	<div class="form-group">
  		<label for="id">아이디</label><input type="text"
  			...
  			<input type="button" class="btn btn-dark float-right" 
  			value="중복검색" onclick="idchk()"><br>
  		...
  		<label class="radio-inline"></label>
  			<input type="radio" name="gender" checked value="2">남<label class="radio-inline"></label>
